...
function initTask(): array
{
    ...
    //
    //а потом ты сделал замечание по поводу внешних данных, и теперь оба варианта не подходят..или я как то не правильно понимаю, ведь в движке тоже используеться внешние данные из константы.
